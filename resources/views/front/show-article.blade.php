            ...
            <div class="col-lg-8">
                ...
                <article>
                    ...
                    <header class="mb-4">
                        ...
                        <div class="text-muted fst-italic mb-2">Posted on {{$article->created_at}}
                            by {{$article->user->name}}</div>

                        <img style="width:100%" src="{{asset($article->image)}}">
                    </header>
                    <!-- Post content-->
                    <section class="mb-5 col-md-4">
                        {!! $article->body !!}
                    </section>
                </article>
                        ...
                        <div class="card-body">
                            ...
                            @auth
                                @if($article->commentable==1)
                                    ...
                                    <form class="mb-4" action="{{route('front.article.add-comment',$article)}}"
                                          method="POST">
                                        @csrf
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            <form action="{{route('front.article.add-replay',[$article,$comment])}}"
